...
public class SosemanukFast implements PRG {
	...
	private void setIV(byte[] iv)
	{
		...
		if (iv.length > 16){
			piv = new byte[16];
			System.arraycopy(iv, 0, piv, 0, 16);
